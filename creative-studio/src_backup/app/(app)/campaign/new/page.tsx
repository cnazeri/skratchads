    ...
    <div className="min-h-[calc(100vh-180px)] bg-slate-100">
      <div className="max-w-[1100px] mx-auto px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-700">Set up a new banner campaign in a few steps</p>
        </div>
          ...
          {[1, 2, 3, 4].map((s) => (
            <div key={s} className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs text-gray-600 mt-1">{stepLabels[s - 1]}</span>
              </div>
              {s < 4 && (
                <div
                  ...
                  <div className="space-y-3 text-sm mb-2">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {industries.map((ind) => (
                          <span key={ind} className="px-2.5 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">{ind}</span>
                        ))}
                      </div>
                    </div>
                    {demographics.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {demographics.map((dem) => (
                            <span key={dem} className="px-2.5 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">{dem}</span>
                          ))}
                        </div>
                      </div>
                    )}
            ...
            {step === 4 && (
              <>
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-2 border border-blue-500 text-blue-500 hover:bg-blue-50 disabled:border-gray-400 disabled:text-gray-400 rounded-lg font-semibold transition-colors"
                >
